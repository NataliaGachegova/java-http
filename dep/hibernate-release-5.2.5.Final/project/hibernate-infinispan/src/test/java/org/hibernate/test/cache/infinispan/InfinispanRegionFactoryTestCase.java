...
public class InfinispanRegionFactoryTestCase  {
	...
	public void testConfigurationProcessing() {
		final String person = "com.acme.Entities.Person";
		final String addresses = "com.acme.Entities.Person.addresses";
		Properties p = createProperties();
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.cfg", "person-cache");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.eviction.strategy", "LRU");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.eviction.max_entries", "5000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.expiration.wake_up_interval", "2000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.expiration.lifespan", "60000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.expiration.max_idle", "30000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.cfg", "person-addresses-cache");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.expiration.lifespan", "120000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.expiration.max_idle", "60000");
	...
	public void testBuildEntityCollectionRegionsPersonPlusEntityCollectionOverrides() {
		...
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.cfg", "addresses-cache");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.eviction.strategy", "LIRS");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.eviction.max_entries", "5500");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.expiration.wake_up_interval", "2500");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.expiration.lifespan", "65000");
		p.setProperty("hibernate.cache.infinispan.com.acme.Entities.Person.addresses.expiration.max_idle", "35000");
	...
	public void testBuildEntityCollectionRegionOverridesOnly() {
		final String address = "com.acme.Address";
		final String personAddressses = "com.acme.Entities.Person.addresses";
		AdvancedCache cache;
		Properties p = createProperties();
		p.setProperty("hibernate.cache.infinispan.entity.eviction.strategy", "LIRS");
	...
	public void testEnableStatistics() {
		...
		try {
			...
			region = (EntityRegionImpl) factory.buildEntityRegion("com.acme.Entities.Person", p, MUTABLE_NON_VERSIONED);
			cache = region.getCache();
			assertTrue(cache.getCacheConfiguration().jmxStatistics().enabled());
			...
			CollectionRegionImpl collectionRegion = (CollectionRegionImpl)
					factory.buildCollectionRegion("com.acme.Entities.Person.addresses", p, MUTABLE_NON_VERSIONED);
			cache = collectionRegion.getCache();
			assertTrue(cache.getCacheConfiguration().jmxStatistics().enabled());
		} finally {
			factory.stop();
