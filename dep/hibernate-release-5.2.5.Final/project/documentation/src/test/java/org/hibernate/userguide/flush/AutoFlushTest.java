...
public class AutoFlushTest extends BaseEntityManagerFunctionalTestCase {
	...
	public void testFlushAutoJPQL() {
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			entityManager.createQuery( "select p from Entities.Person p" ).getResultList();
	...
	public void testFlushAutoSQL() {
		doInJPA( this::entityManagerFactory, entityManager -> {
			entityManager.createNativeQuery( "delete from Entities.Person" ).executeUpdate();;
		} );
		doInJPA( this::entityManagerFactory, entityManager -> {
			log.info( "testFlushAutoSQL" );
			//tag::flushing-auto-flush-sql-example[]
			assertTrue(((Number) entityManager
					.createNativeQuery( "select count(*) from Entities.Person")
	...
	public void testFlushAutoSQLNativeSession() {
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			assertTrue(((Number) session
					.createSQLQuery( "select count(*) from Entities.Person")
