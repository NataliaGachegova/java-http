...
public class FirstLevelCacheTest extends BaseEntityManagerFunctionalTestCase {
    ...
    public void testCache() {
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			for(Person person : entityManager.createQuery("select p from Entities.Person p", Person.class)
					.getResultList()) {
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			for(Person person : (List<Person>) session.createQuery("select p from Entities.Person p").list()) {
				dtos.add(toDTO(person));
