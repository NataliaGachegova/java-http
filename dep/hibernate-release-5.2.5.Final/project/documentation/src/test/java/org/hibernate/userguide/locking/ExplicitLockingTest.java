	...
	public void testFollowOnLocking() {
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			List<Person> persons = entityManager.createQuery(
				"select DISTINCT p from Entities.Person p", Person.class)
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			entityManager.createQuery(
				"select p.id from Entities.Person p where p in :persons")
			.setLockMode( LockModeType.PESSIMISTIC_WRITE )
		...
		doInJPA( this::entityManagerFactory, entityManager -> {
			...
			List<Person> persons = entityManager.createQuery(
				"select p from Entities.Person p", Person.class)
			.setMaxResults( 10 )
			.unwrap( Query.class )
			.setLockOptions(
