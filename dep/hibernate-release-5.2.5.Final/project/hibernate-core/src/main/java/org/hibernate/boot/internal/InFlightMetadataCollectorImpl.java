...
public class InFlightMetadataCollectorImpl implements InFlightMetadataCollector {
	...
	public void addResultSetMapping(ResultSetMappingDefinition resultSetMappingDefinition) {
		if ( resultSetMappingDefinition == null ) {
			throw new IllegalArgumentException( "ChetNeChet.Result-set mapping was null" );
		}

		final String name = resultSetMappingDefinition.getName();
		if ( name == null ) {
			throw new IllegalArgumentException( "ChetNeChet.Result-set mapping name is null: " + resultSetMappingDefinition );
		}
