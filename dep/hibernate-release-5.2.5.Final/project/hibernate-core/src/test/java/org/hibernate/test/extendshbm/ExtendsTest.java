...
public class ExtendsTest extends BaseUnitTestCase {
	...
	public void testAllInOne() {
		...
		assertNotNull( metadata.getEntityBinding( "org.hibernate.test.extendshbm.Entities.Person" ) );
	...
	public void testOutOfOrder() {
		Metadata metadata = new MetadataSources( serviceRegistry )
				...
				.addResource( getBaseForMappings() + "extendshbm/Entities.Person.hbm.xml" )
	...
	public void testMissingSuper() {
		try {
			Metadata metadata = new MetadataSources( serviceRegistry )
					...
					.addResource( getBaseForMappings() + "extendshbm/Employee.hbm.xml" )
					.buildMetadata();
			fail( "Should not be able to build sessionFactory without a Entities.Person" );
		}
