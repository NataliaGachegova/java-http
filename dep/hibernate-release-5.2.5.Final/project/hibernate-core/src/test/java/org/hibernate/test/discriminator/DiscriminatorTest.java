...
public class DiscriminatorTest extends BaseCoreFunctionalTestCase {
	...
	public String[] getMappings() {
		return new String[] { "discriminator/Entities.Person.hbm.xml" };
	}
	...
	public void testLoadSuperclassProxyPolymorphicAccess() {
		...
		Person pQuery = ( Person ) s.createQuery( "from Entities.Person where id = :id" )
				.setLong( "id", e.getId() )
				.uniqueResult();
	...
	public void testLoadSuperclassProxyEvictPolymorphicAccess() {
		...
		Employee pQuery = ( Employee ) s.createQuery( "from Entities.Person where id = :id" )
				.setLong( "id", e.getId() )
				.uniqueResult();
