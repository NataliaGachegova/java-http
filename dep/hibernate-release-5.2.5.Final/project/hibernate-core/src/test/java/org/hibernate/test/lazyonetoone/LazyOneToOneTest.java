...
public class LazyOneToOneTest extends BaseCoreFunctionalTestCase {
	public String[] getMappings() {
		return new String[] { "lazyonetoone/Entities.Person.hbm.xml" };
	}
	...
	public void testLazy() throws Exception {
		...
		p = (Person) s.createQuery("from Entities.Person where name='Gavin'").uniqueResult();
		...
		p2 = (Person) s.createQuery("from Entities.Person where name='Emmanuel'").uniqueResult();
