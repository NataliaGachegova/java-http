...
public class HHH3949TestTask1 extends AbstractHHH3949TestTask {
	...
	public void execute() {
		...
		performQueryAndVerifyResults( "from Entities.Person p fetch all properties left join fetch p.vehicle" );
		performQueryAndVerifyResults( "from Entities.Person p left join fetch p.vehicle" );
	}
