...
public class OneToOneFormulaTest extends BaseCoreFunctionalTestCase {
	...
	public String[] getMappings() {
		return new String[] { "onetoone/formula/Entities.Person.hbm.xml" };
	}
	...
	public void testOneToOneFormula() {
		...
		p = (Person) s.createQuery("from Entities.Person p left join fetch p.mailingAddress left join fetch p.address").uniqueResult();
		...
		p = (Person) s.createQuery("from Entities.Person p left join fetch p.address").uniqueResult();
