...
public class NativeSQLQueryReturnEqualsAndHashCodeTest extends BaseCoreFunctionalTestCase {
	...
	public void testNativeSQLQueryRootReturn() {
		...
		NativeSQLQueryRootReturn aliasEntityName = new NativeSQLQueryRootReturn( "abc", "Entities.Person", null);
		NativeSQLQueryRootReturn aliasDiffEntityName = new NativeSQLQueryRootReturn( "abc", "Customer", null);
		NativeSQLQueryRootReturn aliasEntityNameLockMode = new NativeSQLQueryRootReturn( "abc", "Entities.Person", LockMode.NONE );
		NativeSQLQueryRootReturn aliasEntityNameDiffLockMode = new NativeSQLQueryRootReturn( "abc", "Entities.Person", LockMode.OPTIMISTIC );
		...
		check( true, aliasEntityName, new NativeSQLQueryRootReturn( "abc", "Entities.Person", null) );
		check( true, aliasDiffEntityName, new NativeSQLQueryRootReturn( "abc", "Customer", null) );
		check( true, aliasEntityNameLockMode, new NativeSQLQueryRootReturn( "abc", "Entities.Person", LockMode.NONE ) );
		check( true, aliasEntityNameDiffLockMode, new NativeSQLQueryRootReturn( "abc", "Entities.Person", LockMode.OPTIMISTIC ) );
	}
