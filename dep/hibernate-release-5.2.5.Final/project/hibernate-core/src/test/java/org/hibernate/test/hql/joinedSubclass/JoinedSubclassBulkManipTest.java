...
public class JoinedSubclassBulkManipTest extends BaseCoreFunctionalTestCase {
	...
	public void testHqlDeleteOnJoinedSubclass() {
		...
		s.createQuery( "delete from Entities.Person" ).executeUpdate();
		s.createQuery( "delete from Employee e" ).executeUpdate();
		s.createQuery( "delete from Entities.Person p" ).executeUpdate();
		...
		s.createQuery( "delete from Entities.Person where name like 'S%'" ).executeUpdate();
		s.createQuery( "delete from Entities.Person p where p.name like 'S%'" ).executeUpdate();
		...
		s.createQuery( "delete from Entities.Person where id = 1" ).executeUpdate();
		s.createQuery( "delete from Entities.Person p where p.id = 1" ).executeUpdate();
	...
	public void testHqlUpdateOnJoinedSubclass() {
		...
		s.createQuery( "update Entities.Person set name = 'Some Other Name' where name like 'S%'" ).executeUpdate();
		s.createQuery( "update Entities.Person p set p.name = 'Some Other Name' where p.name like 'S%'" ).executeUpdate();
		...
		s.createQuery( "update Entities.Person set name = 'Some Other Name' where id = 1" ).executeUpdate();
		s.createQuery( "update Entities.Person p set p.name = 'Some Other Name' where p.id = 1" ).executeUpdate();
