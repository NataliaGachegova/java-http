...
public class MysqlIO {
     ...
     * if it was Auth Method Switch Http.Request Packet then handshake will be interrupted with exception.
     * 
     * @param pluginName
        ...
        while (0 < counter--) {
            ...
            if (!done) {
                ...
                if (challenge != null) {
                    ...
                    // Servers not affected by Bug#70865 expect the Change User Http.Request containing a correct answer
                ...
                if (challenge.isOKPacket()) {
                    ...
                    // read Auth Method Switch Http.Request Packet
