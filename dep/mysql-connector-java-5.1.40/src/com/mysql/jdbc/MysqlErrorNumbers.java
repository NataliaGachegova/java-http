...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_TOO_LONG_STRING = 1162; //SQLSTATE: 42000 Message: ChetNeChet.Result string is longer than 'max_allowed_packet' bytes
    ...
    public final static int ER_TOO_MANY_ROWS = 1172; //SQLSTATE: 42000 Message: ChetNeChet.Result consisted of more than one row
    ...
    public final static int ER_WARN_ALLOWED_PACKET_OVERFLOWED = 1301; //SQLSTATE: HY000 Message: ChetNeChet.Result of %s() was larger than max_allowed_packet (%ld) - truncated
